...
from th99_four_bar_renderer import remaining_percent
...
class BoundedPercentTests(unittest.TestCase):
    ...
    def test_remaining_capacity_is_the_complement_of_used_utilization(self):
        self.assertEqual(remaining_percent(0), 100)
        self.assertEqual(remaining_percent(38), 62)
